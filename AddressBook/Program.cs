namespace AddressBook
{
    internal class Program
    {
        ...
        static void ShowAllContacts(AddressBook addressBook)
        {
            ...
            {
                Console.WriteLine($"Name: {contact.FirstName} {contact.LastName}, Address: {contact.Address}, City: {contact.City}, State: {contact.State}, Zip: {contact.Zip}, Phone Number: {contact.PhoneNumber}, Email: {contact.Email}");
            }
        }
